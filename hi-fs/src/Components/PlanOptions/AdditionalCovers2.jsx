...
export const AdditionalCovers2 = () => {
  var data;
  ...
  const sendData = () => {
    ...
    axios
      .post(`http://localhost:8000/user`, {
        ...
        premium: +zeroDepreciationPlan + (zeroDepreciationPlan * 20) / 80,
        paCover: +added,
        ncbDiscountAmount: (+zeroDepreciationPlan * 20) / 80,
      })
      .then((res) => {
          ...
          <div className={styles.insideContRight}>
            ...
            <div>
              ...
              <div>
                ...
                <div>
                  <button
                    onClick={event =>  window.location.href='https://buy.stripe.com/test_bIYg1JaKtdaq3Mk5km'}
                    // onClick={() => {
                    //   sendData();
